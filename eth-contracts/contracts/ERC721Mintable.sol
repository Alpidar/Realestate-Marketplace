...
contract Ownable {
    ...
    event ownershipTransferred(address originalOwner, address newOwner);
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), 'Real address required');
        address originalOwner = _owner;
        _owner = newOwner;
        emit ownershipTransferred(originalOwner, _owner);
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require (msg.sender == getOwner() || isApprovedForAll(ownerOf(tokenId), to));
